...
#note to self - find out why this new column doesn't show in the tibble
glimpse(penguins)
```
...
#look at R4DS chapter 18 on how to hnadle missing values
```
...
#why can't mean handle na vlaues the same as max/min
```
...
#don't need to group/sumamrise - just use count
```
